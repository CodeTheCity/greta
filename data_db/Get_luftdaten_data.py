...
def removesensor():
    for file in os.listdir(file_directory):
        if os.path.isfile(os.path.join(file_directory, file)) and '8554' in file:
            os.remove(file_directory + file)
            print('buggy file removed: ' + file)
        if os.path.isfile(os.path.join(file_directory, file)) and '8555' in file:
            os.remove(file_directory + file)
            print('buggy file removed: ' + file)
        if os.path.isfile(os.path.join(file_directory, file)) and '8556' in file:
            os.remove(file_directory + file)
            print('buggy file removed: ' + file)
#there is one buggy sensor that destroys my vsc, deleted it
...
def main():
    ...
    MrParsy()
    print('Final Parsing data to JSON')
    finalEverySensor()
